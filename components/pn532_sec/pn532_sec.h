...
static const uint8_t PN532SEC_COMMAND_VERSION_DATA = 0x02;
static const uint8_t PN532SEC_COMMAND_SAMCONFIGURATION = 0x14;
static const uint8_t PN532SEC_COMMAND_RFCONFIGURATION = 0x32;
static const uint8_t PN532SEC_COMMAND_INDATAEXCHANGE = 0x40;
static const uint8_t PN532SEC_COMMAND_INLISTPASSIVETARGET = 0x4A;

class PN532SECBinarySensor;

class PN532SEC : public PollingComponent {
 public:
  void setup() override;
  ...
  void register_tag(PN532SECBinarySensor *tag) { this->binary_sensors_.push_back(tag); }
 ...
 protected:
  ...
  std::vector<PN532SECBinarySensor *> binary_sensors_;
...
class PN532SECBinarySensor : public binary_sensor::BinarySensor {
 public:
...
class PN532SECOnFinishedWriteTrigger : public Trigger<> {
 public:
  explicit PN532SECOnFinishedWriteTrigger(PN532SEC *parent) {
    parent->add_on_finished_write_callback([this]() { this->trigger(); });
  }
};

template<typename... Ts> class PN532SECIsWritingCondition : public Condition<Ts...>, public Parented<PN532SEC> {
 public:
